...
<div class="container-fluid dashboard-container">
    <h1 class="mb-4 dashboard-title"><i class="fas fa-user"></i> Admin Profile</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="text-center position-relative">
                            <img src="<?php echo file_exists("../images/users/{$user['id']}.jpg") ? "../images/users/{$user['id']}.jpg?v=" . time() : "https://via.placeholder.com/150?text=Admin"; ?>" class="img-fluid rounded-circle" alt="Profile Picture" style="width: 400px; height: 400px; object-fit: cover;">
